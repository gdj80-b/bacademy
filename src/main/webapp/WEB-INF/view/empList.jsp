		...
		<div class="d-flex flex-column justify-content-first p-4">
			<nav aria-label="Page navigation example">
			 	<ul class="pagination pagination-sm justify-content-end">
	 				<li class="page-item ${prevBtn}"><a class="page-link" href="/empList?currentPage=1">&laquo;</a></li>
  					<li class="page-item ${prevBtn}"><a class="page-link" href="/empList?currentPage=${paging.currentPage - 1}">&lsaquo;</a></li>
	 				<li class="page-item"><a class="page-link" href="/empList?currentPage=${paging.currentPage}">${paging.currentPage}</a></li>
			    	<li class="page-item ${nextBtn}"><a class="page-link" href="/empList?currentPage=${paging.currentPage + 1}">&rsaquo;</a></li>
			    	<li class="page-item ${nextBtn}"><a class="page-link" href="/empList?currentPage=${paging.lastPage}">&raquo;</a></li>
			 	</ul>
			</nav>
