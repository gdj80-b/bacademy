...
<head>
  ...
  <script type="text/javascript">
    ...
    function goInsert() {
        ...
        if (id.trim() === "" || pw1.trim() === "" 
        		|| pw2.trim() === "" || name.trim() === "" 
        		|| birth.trim() === "" || phoneNum.trim() === "" || email.trim() === "") {
            alert("모든 필드를 입력하세요.");
            return false;
        }
		if (pw1 !==pw2) {
      ...
      <form name="frm" action="${contextPath}/memberJoin" method="post">
         ...
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           ...
           <tr>
             ...
             <td colspan="2"><input id="birth" name="birth" class="form-control" type="date" maxlength="20" placeholder="나이를 입력하세요."/></td>            
           </tr>
           <tr>
           ...
           <tr>
           	...
           	<td colspan="2"><input id="phoneNum" name="phoneNum" class="form-control" type="text" oninput="oninputPhone(this)" maxlength="14" placeholder="번호만 입력하세요."/></td>            
           </tr>
           <tr>
