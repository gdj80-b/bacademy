...
public class StudentInfoController {
	...
	public String studentMainPage(@RequestParam(name="lectureStatus", defaultValue = "") String lectureStatus, HttpSession session, RedirectAttributes rattr, Model model) {
		// 세션 로그인 여부 확인
